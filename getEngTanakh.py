...
PROPHETS_FILE = "Prophets_eng.json"
SCRIPTURES_FILE = "Scriptures_eng.json"
TANAKH_OUTLINE_FILE = "tanakhOutlineEng.json"
...
if __name__ == "__main__":
    ...
    if choice == '1':
        ...
        print(f"Invalid choice. Please enter 1 through 5. line: {inspect.currentframe().f_lineno}: Exiting...")